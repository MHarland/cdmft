...
class DMFTParameters:
    ...
    def __init__(self, parameter_dict = {}):
        self.solver_run = ["n_cycles", "partition_method", "quantum_numbers", "length_cycle", "n_warmup_cycles", "random_name", "max_time", "verbosity", "move_shift", "move_double", "use_trace_estimator", "measure_g_tau", "measure_g_l", "measure_pert_order", "measure_density_matrix", "use_norm_as_weight", "performance_analysis", "proposal_prob", "imag_threshold", "perform_post_proc", "perform_tail_fit", "fit_min_n", "fit_max_n", "fit_min_w", "fit_max_w", "fit_max_moment", "move_global", "move_global_prob", "measure_g2_inu", "measure_g2_legendre", "measure_g2_pp", "measure_g2_ph", "measure_g2_block_order", "measure_g2_n_iw", "measure_g2_n_inu", "measure_g2_n_l"]#, "measure_g_pp_tau"]# "measure_g2_blocks"
