...
for fname in sys.argv[1:]:
    ...
    n_inds = len(inds)
    beta = g2[inds[0][0], inds[0][1], inds[0]
              [2], inds[0][3]].mesh.components[0].beta
    n_iw = int(len(g2[inds[0][0], inds[0][1], inds[0][2],
                      inds[0][3]].mesh.components[0])*.5) + 1
    ...
    giw = Block2Gf(name_list1=n1, name_list2=n2, block_list=[[GfImFreq(
        beta=beta, indices=[0], statistic='Boson', n_points=n_iw) for m in n2] for n in n1])
    for s, b in g2:
