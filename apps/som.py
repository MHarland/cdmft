...
run_params['max_time'] = -1#2*60
run_params['verbosity'] = 2
run_params['t'] = 500#1000
run_params['f'] = 50#100
run_params['adjust_f'] = False#True
run_params['l'] = 500
run_params['adjust_l'] = False
run_params['make_histograms'] = False#True
for archive_name in sys.argv[1:]:
    ...
    g_rec = tr_g.copy()
    gw = GfReFreq(window = (-8.0,8.0), n_points = 2000, indices = tr_g.indices)
    trace(g, tr_g)
    s = tr_g.copy()
    s.data[:,0,0] = 1.0 # TODO think!
